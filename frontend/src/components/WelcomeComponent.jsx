...
const WelcomeComponent = () => {
  ...
  const login = async (username, password) => {
    try {
      const loginSuccessful = await RegisterLoginService.login(username, password);
  ...
  return (
    <div className="bg-light-sage-green min-h-screen flex justify-center flex-col">
      <header className="bg-light-sage-green shadow-2xl h-12 p-3 font-bold">
        LOGO
      </header>
      <div className="flex flex-grow">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-center w-9/12">
            <i>
              Welcome to ToolHub! Your community-centric platform for sharing
              and collaborating on tools. Join groups based on your location and
              trade to connect with like-minded individuals. From carpentry to
              gardening, ToolHub facilitates seamless tool sharing, making your
              projects easier. Join us, and let's expand your toolbox together
              at ToolHub – where community meets craftsmanship!
            </i>
          </div>
        </div>
        <div className="bg-white flex-grow bg-opacity-75 p-5 flex flex-col items-center justify-center shadow-2xl h-screen w-60">
          <div className="text-center text-xl font-bold h-40">
          ...
          <div>
            <button
              className="bg-light-sage-green text-black rounded-md p-1 font-bold text-2xl shadow-xl hover:bg-gray-800 hover:text-white my-5 px-5"
