...
const ContactPage = () => {
    return (
        ...
        <ContactCard imageUrl="/src/assets/emptyImage.webp" description="This is " name="Brogan Reed" linkedIn="https://www.linkedin.com/in/brogan-reed/" website="https://brogandr.github.io/"/>
        </div>
        </div>
    )
}
