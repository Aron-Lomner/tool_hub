...
const UserResult = ({ user }) => {
  return (
    <div className="flex flex-row items-center flex-grow-[10] border border-gray-300 w-full bg-[#ffffff55] backdrop-blur box-border">
      ...
      <button onClick= "" className="bg-violet-700 hover:bg-violet-950 text-white px-2 py-2 rounded-md font-bold shadow-md ml-auto mr-2 mb-2 transition-transform transform-gpu hover:scale-105">
        Message
      </button>
    </div>
  );
